 ...
 * @version cetus-vortal-ejb (18/12/2014)
 */
public class PropertiesLoader {
   ...
   *
   * @author Jose David Salcedo M. - Cetus Technology
   * @since cetus-vortal-ejb (18/12/2014)
   */
  ...
  public Properties load () {
    try {
      ...
      Util.CETUS_CORE.error( "Error cargando archivo de propiedades " + e.getMessage() );
    }
    return properties;
  }
  ...
  public String getProperty ( String prop, String vDefalult ) {
    Util.CETUS_CORE.debug( "Obteniendo propiedad prop=" + prop + " vDefalult=" + vDefalult );
    String value = "";
    try {
      value = properties.getProperty( prop, vDefalult );
      if ( value == null ) {
        System.err.println( "ERROR propiedad NULA " + prop );
        Util.CETUS_CORE.error( "ERROR propiedad NULA " + prop );
        Util.CETUS_CORE.error( "Asignando variable por defecto a la propiedad " + prop + " vDefalult=" + vDefalult );
      }
    } catch ( Exception e ) {
      Util.CETUS_CORE.error( "ERROR propiedad NULA " + prop, e );
      Util.CETUS_CORE.error( "Asignando variable por defecto a la propiedad " + prop + " vDefalult=" + vDefalult );
    }
    return value;
