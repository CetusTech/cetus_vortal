 ...
 */
public class InterceptorFindRolByApplication extends CustomerProcess {
	...
	public Object interceptService(InvocationContext ctx) throws Exception {
		...
		FindRolsByApplicationResponseDTO responseDTO = null;
		Object[] parameter = null;
		ValidPermServiceRequestDTO validPermDTO = null;
		UserWSDTO userWSDTO = null;
		try {
			responseDTO = new FindRolsByApplicationResponseDTO();
			...
			if (!Util.validateResponseSuccess(response)) {
				...
				responseDTO = (FindRolsByApplicationResponseDTO) ctx.proceed();
			}
