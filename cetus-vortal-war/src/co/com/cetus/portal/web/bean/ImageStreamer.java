...
@ManagedBean
@RequestScoped
public class ImageStreamer extends GeneralManagedBean {
  ...
  public StreamedContent getFileContent () {
    try {
      ...
      if ( idApp == null || idApp.equals( "" ) ) {
        ...
        if ( app != null && app.getImagenCuerpo() != null
             && idApp.equals( String.valueOf( app.getId() ) ) ) {
          InputStream inputStream = new ByteArrayInputStream( app.getImagenCuerpo() );
