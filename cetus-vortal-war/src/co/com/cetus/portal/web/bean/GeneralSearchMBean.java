...
public class GeneralSearchMBean extends GeneralManagedBean {
  ...
  public GeneralSearchMBean () {
    ...
    filter1 = new FilterSearch();
    filter2 = new FilterSearch();
    filter3 = new FilterSearch();
    filter4 = new FilterSearch();
    filter5 = new FilterSearch();
    filter6 = new FilterSearch();
    filter7 = new FilterSearch();
    filter8 = new FilterSearch();
    filter9 = new FilterSearch();
    filter10 = new FilterSearch();
  ...
  public String add () {
    ...
    try {
      ...
      if ( addObject != null && addObject.getAppSerId().getTbAplicacion().getId() > 0 ) {
        ...
        addMessageError( null, Util.getProperty( ConstantView.NAME_BUNDLE_VIEW, ConstantView.Internalizacion.ERROR_INPUT_PARAM ),
                         ConstantView.ERROR );
      }
  ...
  public void loadAdd () {
    try {
      if ( addObject != null && addObject.getDescription() != null && !addObject.getDescription().isEmpty() ) {
