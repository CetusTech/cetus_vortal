 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceService", targetNamespace = "http://service.ejb.portal.cetus.com.co/", wsdlLocation = "http://localhost:9099/cetus-vortal-ejb/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICESERVICE_QNAME = new QName("http://service.ejb.portal.cetus.com.co/", "CustomerServiceService");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://service.ejb.portal.cetus.com.co/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ejb.portal.cetus.com.co/", "CustomerServicePort"), CustomerService.class, features);
    }
